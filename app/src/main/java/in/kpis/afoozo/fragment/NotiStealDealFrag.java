...
import com.kpis.afoozo.databinding.FragmentNotiStealDealBinding;
 ...
 */
public class NotiStealDealFrag extends Fragment {

    private Context mContext;

    private View view;

    private FragmentNotiStealDealBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_noti_steal_deal, container, false);
    ...
    private void callNotificationApi() {
        try {
            ...
            }).callAPIJson(mContext, Constants.VAL_GET, AppUrls.GET_NOTIFICATION_LIST + "StealDeal", "", "Loading...", true, AppUrls.REQUESTTAG_GETNOTIFICATIONLIST);
