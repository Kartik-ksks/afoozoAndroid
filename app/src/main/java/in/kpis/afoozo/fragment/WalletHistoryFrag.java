...
import com.kpis.afoozo.databinding.FragmentWalletHistoryBinding;
 ...
 */
public class WalletHistoryFrag extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_wallet_history, container, false);
...
//        datePickerDialog.getDatePicker().setMinDate(minDate);
    ...
    private void setData() {
        binding.rvHistory.setAdapter(new WalletHistoryAdapter(mContext, list));
    }
    ...
    private void callGetHistoryListApi() {
        try {
            ...
            }).callAPIJson(mContext, Constants.VAL_GET, AppUrls.GET_WALLET_TRANSACTION_LIST_DATA + "0/-1" + "/" + startLong + "/" + endLong, "", "Loading...", true, AppUrls.REQUESTTAG_GETWALLETTRANSACTIONLISTDATA);
