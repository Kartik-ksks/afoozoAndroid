...
import com.kpis.afoozo.databinding.FragmentNotiTakeAwayBinding;
 ...
 */
public class NotiTakeAwayFrag extends Fragment {
    ...
    private FragmentNotiTakeAwayBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_noti_take_away, container, false);
    ...
    private void initialize() {
        binding.rvTakeAway.setLayoutManager(new LinearLayoutManager(mContext));
        binding.rvTakeAway.setItemAnimator(new DefaultItemAnimator());
    ...
    private void callNotificationApi() {
        try {
            ...
            }).callAPIJson(mContext, Constants.VAL_GET, AppUrls.GET_NOTIFICATION_LIST + "TakeAway", "", "Loading...", true, AppUrls.REQUESTTAG_GETNOTIFICATIONLIST);
    ...
    private void setData() {
        ...
        binding.rvTakeAway.setAdapter(mAdapter);
