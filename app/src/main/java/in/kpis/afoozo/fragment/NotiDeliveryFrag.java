...
import com.kpis.afoozo.databinding.FragmentNotiDeliveryBinding;
 ...
 */
public class NotiDeliveryFrag extends Fragment {

    private Context mContext;

    private View view;

    private FragmentNotiDeliveryBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_noti_delivery, container, false);
    ...
    private void initialize() {
        binding.rvDelivery.setLayoutManager(new LinearLayoutManager(mContext));
    ...
    private void callNotificationApi() {
        try {
            ...
            }).callAPIJson(mContext, Constants.VAL_GET, AppUrls.GET_NOTIFICATION_LIST + "HomeDelivery", "", "Loading...", true, AppUrls.REQUESTTAG_GETNOTIFICATIONLIST);
    ...
    private void setData() {
        ...
        binding.rvDelivery.setAdapter(mAdapter);
