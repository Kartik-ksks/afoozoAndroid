...
import com.kpis.afoozo.databinding.FragmentNotiEventBinding;
 ...
 */
public class NotiEventFrag extends Fragment {

    private Context mContext;

    private View view;

    private FragmentNotiEventBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_noti_event, container, false);
    ...
    private void initialize() {
        binding.rvEvent.setLayoutManager(new LinearLayoutManager(mContext));
    ...
    private void callNotificationApi() {
        try {
            ...
            }).callAPIJson(mContext, Constants.VAL_GET, AppUrls.GET_NOTIFICATION_LIST + "Event", "", "Loading...", true, AppUrls.REQUESTTAG_GETNOTIFICATIONLIST);
    ...
    private void setData() {
        ...
        binding.rvEvent.setAdapter(mAdapter);
