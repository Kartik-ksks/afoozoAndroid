...
import com.kpis.afoozo.databinding.FragmentNotiDineInBinding;
 ...
 */
public class NotiDineInFrag extends Fragment {

    private Context mContext;

    private View view;

    private FragmentNotiDineInBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_noti_dine_in, container, false);
    ...
    private void initialize() {
        binding.rvDineIn.setLayoutManager(new LinearLayoutManager(mContext));
    ...
    private void callNotificationApi() {
        try {
            ...
            }).callAPIJson(mContext, Constants.VAL_GET, AppUrls.GET_NOTIFICATION_LIST + "DineIn", "", "Loading...", true, AppUrls.REQUESTTAG_GETNOTIFICATIONLIST);
    ...
    private void setData() {
        ...
        binding.rvDineIn.setAdapter(mAdapter);
