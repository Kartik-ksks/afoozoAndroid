...
import com.kpis.afoozo.databinding.FragmentNotiOthersBinding;
 ...
 */
public class NotiOthersFrag extends Fragment {

    private Context mContext;

    private View view;

    private FragmentNotiOthersBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_noti_others, container, false);
    ...
    private void initialize() {
        binding.rvOthers.setLayoutManager(new LinearLayoutManager(mContext));
        binding.rvOthers.setItemAnimator(new DefaultItemAnimator());
    ...
    private void callNotificationApi() {
        try {
            ...
            }).callAPIJson(mContext, Constants.VAL_GET, AppUrls.GET_NOTIFICATION_LIST + "Other", "", "Loading...", true, AppUrls.REQUESTTAG_GETNOTIFICATIONLIST);
    ...
    private void setData() {
        ...
        binding.rvOthers.setAdapter(mAdapter);
