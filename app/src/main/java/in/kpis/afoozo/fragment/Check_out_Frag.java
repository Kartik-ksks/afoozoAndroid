...
import com.kpis.afoozo.databinding.FragmentCheckOutBinding;
...
public class Check_out_Frag extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_check_out_, container, false);
    ...
    private void initialize() {
        ...
        callGetHistryOrdersApi();
    }

    private void callGetHistryOrdersApi() {
...
//
            ...
            }).callAPIJson(mContext, Constants.VAL_GET, AppUrls.GET_ROOM_BOOKING_LIST + "History/0/1000", "", "Loading...", true, AppUrls.REQUESTTAG_GETROOMBOOKINGLIST);
